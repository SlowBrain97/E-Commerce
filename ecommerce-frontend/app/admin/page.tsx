  ...
  if (!dashboard) {
    return (
      <div className="container-custom py-12 text-center">
        <p className="text-semi-text">Failed to load dashboard data</p>
      </div>
    );
  }
  ...
  return (
    <div className="container-custom py-12">
          ...
          >
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-sm text-semi-text mb-1">{stat.title}</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        ...
        <Card>
          <CardHeader>
            <h2 className="text-xl font-bold text-main-text">Recent Orders</h2>
          </CardHeader>
          <CardContent>
              ...
              {dashboard.recentOrders.recentOrders.slice(0, 5).map((order) => (
                <div key={order.orderId} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
                  <div>
                    ...
                    <p className="text-sm text-semi-text">{order.customerName}</p>
                  </div>
        ...
        <Card>
          <CardHeader>
            <h2 className="text-xl font-bold text-main-text">Top Products</h2>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {dashboard.topProducts.topProducts.slice(0, 5).map((product, index) => (
                <div key={product.productId} className="flex items-center gap-4 py-3 border-b border-gray-100 last:border-0">
                  <div className="w-8 h-8 rounded-full bg-main-text text-white flex items-center justify-center font-bold text-sm">
                    {index + 1}
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-main-text line-clamp-1">
                      {product.productName}
                    </p>
                    <p className="text-sm text-semi-text">{product.categoryName}</p>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold text-main-text">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card>
          <CardHeader>
            <h3 className="font-bold text-main-text">Order Statistics</h3>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-semi-text">Pending</span>
                <span className="font-semibold text-main-text">
                  {dashboard.orderStats.pendingOrders}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Processing</span>
                <span className="font-semibold text-main-text">
                  {dashboard.orderStats.processingOrders}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Delivered</span>
                <span className="font-semibold text-main-text">
                  {dashboard.orderStats.deliveredOrders}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Cancelled</span>
                <span className="font-semibold text-main-text">
        ...
        <Card>
          <CardHeader>
            <h3 className="font-bold text-main-text">Product Statistics</h3>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-semi-text">Active Products</span>
                <span className="font-semibold text-main-text">
                  {dashboard.productStats.activeProducts}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Low Stock</span>
                <span className="font-semibold text-orange-600">
                  {dashboard.productStats.lowStockProducts}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Out of Stock</span>
                <span className="font-semibold text-red-600">
                  {dashboard.productStats.outOfStockProducts}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Categories</span>
                <span className="font-semibold text-main-text">
        ...
        <Card>
          <CardHeader>
            <h3 className="font-bold text-main-text">User Statistics</h3>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-semi-text">Active Users</span>
                <span className="font-semibold text-main-text">
                  {dashboard.userStats.activeUsers}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">New This Month</span>
                <span className="font-semibold text-main-text">
                  {dashboard.userStats.newUsersThisMonth}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">New This Week</span>
                <span className="font-semibold text-main-text">
                  {dashboard.userStats.newUsersThisWeek}
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-semi-text">Admins</span>
                <span className="font-semibold text-main-text">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-orange-800">
                You have {dashboard.productStats.lowStockProducts} products with low stock levels. 
